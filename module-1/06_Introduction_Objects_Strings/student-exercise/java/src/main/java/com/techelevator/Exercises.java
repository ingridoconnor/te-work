...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		String copy = str.substring(length - 2, length);
	...
	public boolean endsLy(String str) {
		if (str.length() >= 2)
			return (str.substring(str.length() - 2).contentEquals("ly"));
		else {
		return false;
		}
	}
	...
	public boolean hasBad(String str) {
		...
		return(indexOfBad == 0 || indexOfBad == 1);
...
//	return false;
	...
	int firstThree = 3;
	    if (firstThree >= str.length()) firstThree = str.length();
	    String times = str.substring(0, firstThree);
	...
	public String altPairs(String str) {
		...
		for(int i = 0; i < str.length(); i += 4 ) {
			...
			if (i + 1 < str.length()) {
				myString = myString + str.charAt(i + 1);
			}
		}
		return myString;
	}
